...
let preference = userPreference === 'Sugar-free' ? 'Sugar-free' : userPreference === 'Regular' ? 'Regular' : 'Regular';
console.log(`Preferred variety: ${preference}`);


// #### Challenge 2: Stock Check
// You have a variable that tracks the number of Monster Energy cans left in the fridge. 
// Use a ternary operator to print "Time to restock!" if the number is less than 5, or "// #### Challenge 2: Stock Check
...
let message1 = heartRate <100 ? "Boost needed!" : "Energy levels are high!";
...
let currentHour = 6; 
let message3 = currentHour >= 7 && currentHour <= 23 ? "Unleash the beast!" : "Better stick to water.";
